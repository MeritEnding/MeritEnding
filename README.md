...
| **[AI 기반 보드게임 기획/개발 어시스턴스](https://github.com/illilili/boardgame-assistant.git)** | 2025.07 ~ 2025.09 | LLM, RAG 등의 AI를 활용한 보드게임 제작 지원 플랫폼 개발. RAG 기반 기획안 자동 생성, 규칙 시뮬레이션, 저작권 검사 및 2D/3D 프로토타입 생성까지 통합 지원. Spring Boot, React 기반 협업 웹서비스 구현. | ![AI Application](https://img.shields.io/badge/AI%20Application-FF4500?style=flat-square&logo=OpenAI&logoColor=white) ![Backend](https://img.shields.io/badge/Backend-00599C?style=flat-square&logo=springboot&logoColor=white) ![Frontend](https://img.shields.io/badge/Frontend-61DAFB?style=flat-square&logo=react&logoColor=black) |
